...
path = Path('scripts/bootstrap-i386-efi-grub.bash')
text = path.read_text()
...
if 'GRUB_I386_SOURCE_FORMULA' in text or 'fetch --build-from-source "$FORMULA"' in text:
    raise SystemExit('obsolete Homebrew GRUB source path survived replacement')
