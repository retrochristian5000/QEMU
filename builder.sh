...
./configure --enable-gtk --enable-slirp --prefix="$PREFIX" --target-list="$QEMU_TARGET_LIST" --without-default-devices --without-default-features --with-devices-ppc="$PPC_ARCH_DEVICE_FILE"
make all install
