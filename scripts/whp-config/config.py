...
OPTIONS = (
    ...
    Option('BOOTSTRAP_LIBTOOL', 'Host features', 'Bootstrap/use WHP Libtool', 'choice', 'auto', ('auto', 'y', 'n')),
    Option('BOOTSTRAP_LIBISOFS', 'Host features', 'Bootstrap/use WHP libisofs', 'choice', 'auto', ('auto', 'y', 'n')),
