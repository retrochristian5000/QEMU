...
SHELL_INVENTORY="$BUILD_SYSTEM_DIR/shell-inventory.bash"
...
if grep -Fq '/scripts/whp-build/stages.bash"' "$SHELL_INVENTORY"; then
    printf 'error: retired stage loader remains in active shell inventory\n' >&2
    exit 1
fi
